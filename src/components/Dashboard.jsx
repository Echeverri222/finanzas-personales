...
export default function Dashboard({ onQuickMovement }) {
  ...
  // Al cargar movimientos, hacer join local para mostrar nombre/meta
  ...
  // Adaptar filtros y reportes para usar tipos personalizados
  ...
  const getPreviousMonthData = () => {
    ...
    const previousMonthMovimientos = movimientosConTipo.filter(mov => {
      const movDate = createSafeDate(mov.fecha); // Usar función segura
  ...
  const getCategoryStats = () => {
    ...
    const categoryMovimientos = movimientosConTipo.filter(mov => mov.tipo_nombre === categoryFilter);
